...
(function($) {
  ...
  Private.prototype.createCacheDir = function(success_callback, error_callback) {
    ...
    this.imgCache.attributes.filesystem.root.getDirectory(this.imgCache.options.localCacheFolder, {
      create: true,
      exclusive: false
  ...
  Private.prototype.loadCachedFile = function($element, img_src, set_path_callback, success_callback, error_callback) {
    ...
    this.imgCache.attributes.filesystem.root.getFile(this.getCachedFilePath(img_src), {
      create: false
    }, _gotFileEntry, _fail);
  };
  ...
  ImgCache.prototype.removeFile = function(img_src, success_callback, error_callback) {
    ...
    this.attributes.filesystem.root.getFile(filePath, {
      create: false
    }, function(fileEntry) {
      fileEntry.remove(
        function() {
